...
const ITEMS = [
  ...
  {
    slug: "harlequin-crest-08",
    name: "Harlequin Crest",
    title: "1.08 Harlequin Crest",
    ...
    lastPatch: "1.08",
    tooltip: [
      { t: "Defense: 222", c: "white" },
      { t: "Required Strength: 50", c: "white" },
      { t: "Required Level: 62", c: "white" },
      "Indestructible",
      "+2 to All Skills",
    ...
    rarityTier: "Very Rare",
    obscurity: 3,
    why: "The Shako everyone wears gives life and mana by character level, ten percent damage reduced, and two points in every attribute. This one gives forty percent maximum life on one line, and it cannot break. No helm the game makes now carries a percentage of maximum life at all. Same two skills, same magic find, a completely different reason to wear it.",
    history: "Patch 1.09 rewrote the Shako into the all-rounder it is today, trading the flat forty percent for per-level life and mana and adding the damage reduced. The 1.08 copies kept the percentage and the indestructible line. It is the most recognised helm in the game hiding a stat the game abandoned.",
    ifYouFind: "Increase Maximum Life 40% is the tell. Nothing that drops now has it, on a Shako or anywhere else."
  },
  {
    slug: "arreats-face-08",
    name: "Arreat's Face",
    title: "1.08 Arreat's Face",
    alias: "target defense, not resistances",
    quality: "unique",
    type: "Slayer Guard",
    sprite: "img/arreats-face.png",
    proof: "research/reference-screenshots/arreats-face-108.webp",
    lastPatch: "1.08",
    tooltip: [
      { t: "Defense: 151", c: "white" },
      { t: "Durability: 40 of 55", c: "white" },
      { t: "(Barbarian Only)", c: "white" },
    ...
    rarityTier: "Very Rare",
    obscurity: 4,
    why: "The Arreat's Face people know is defensive. Thirty to all resistances, twenty strength, twenty dexterity, life steal, a hundred and fifty enhanced defense. This one is an attacking helm wearing the same name. It cuts fifteen percent off the target's defense and adds maximum damage that climbs half a point per level, reaching forty nine at the cap. A barbarian helm that helps you hit rather than survive.",
    history: "Patch 1.09 took out the target defense and the per-level damage and put in resistances, attributes and life steal. That made it better for almost every barbarian and took away the one thing duellers wanted it for. The old copies kept the offensive block and never gained the rest.",
    ifYouFind: "Target defense on a helm dates it on sight. The combat skills line is a second check, since it reads plus one here and plus two on the modern helm."
  },
  {
    slug: "hellmouth-08",
    name: "Hellmouth",
    title: "1.08 Hellmouth",
    alias: "cannot be frozen on gloves",
    quality: "unique",
    type: "War Gauntlets",
    sprite: "img/war-gauntlets.webp",
    proof: "research/reference-screenshots/hellmouth-108.webp",
    lastPatch: "1.08",
    tooltip: [
      { t: "Defense: 135", c: "white" },
      { t: "Durability: 23 of 24", c: "white" },
      { t: "Required Strength: 110", c: "white" },
    ...
    rarityTier: "Very Rare",
    obscurity: 4,
    why: "Cannot be frozen normally costs a ring, and Raven Frost is the ring you spend it on. These gloves carry it outright. In 1.08 that handed a melee character the whole ring slot back, and no glove in the game has done it since. The meteor proc and the fire damage are decoration next to that one line.",
    history: "Patch 1.09 rebuilt Hellmouth around fire and nothing else. It gained a firestorm proc, wider fire damage and fifteen percent fire absorb, and lost the cannot be frozen along with the fire resist. Nobody chases the version that drops now.",
    ifYouFind: "Cannot Be Frozen on a glove is the whole story. Check the meteor line too. It reads level one here and level four on the modern pair."
  },
  {
    slug: "raven-frost-08",
    name: "Raven Frost",
    title: "1.08 Raven Frost",
    alias: "no dexterity at all",
    quality: "unique",
    type: "Ring",
    sprite: "img/ring.png",
    proof: "research/reference-screenshots/raven-frost-108.webp",
    lastPatch: "1.08",
    tooltip: [
    ...
    rarityTier: "Uncommon",
    obscurity: 3,
    why: "Raven Frost is the dexterity ring. Fifteen to twenty dex, two hundred odd attack rating, forty mana, cold absorb, cannot be frozen. Take all of that away except the last line and this is what is left. In its place sit a frost nova that fires when you are struck and thirty five cold resist, neither of which the modern ring has. Plainly the worse ring, and the only Raven Frost that ever cast a spell.",
    history: "Patch 1.09 turned Raven Frost into the staple it is by adding the dexterity, the attack rating, the mana and the absorb. Before that it was a cannot-be-frozen ring with a proc attached, worth wearing for one line. The old copies never gained any of it.",
    ifYouFind: "No dexterity line. That is the whole check. Every Raven Frost that drops now has one, and none of them cast frost nova."
  },
  {
    slug: "bartucs-08",
    name: "Bartuc's Cut-Throat",
    title: "1.08 Bartuc's Cut-Throat",
    alias: "fifty attack speed and blind",
    quality: "unique",
    type: "Greater Talons",
    sprite: "img/greater-talons.png",
    proof: "research/reference-screenshots/bartucs-cut-throat-108.webp",
    lastPatch: "1.08",
    tooltip: [
      { t: "One-Hand Damage: 28 to 47", c: "white" },
      { t: "Durability: 37 of 69", c: "white" },
      { t: "(Assassin Only)", c: "white" },
    ...
    rarityTier: "Very Rare",
    obscurity: 4,
    why: "The Bartuc's that drops now is a martial arts claw with life steal, flat damage and attributes. This one is a speed and debuff weapon. Fifty percent increased attack speed, twenty five percent deadly strike, thirty five off the target's defense, and every hit blinds. Hit Blinds Target is not printed on any claw the game makes today.",
    history: "Patch 1.09 moved the class line from shadow disciplines to martial arts, removed the attack speed entirely, and traded the deadly strike, the blind and the target defense for life steal, twenty strength and twenty dexterity. Two different weapons sharing a name.",
    ifYouFind: "Hit Blinds Target, or the skill line reading Shadow Disciplines where the modern claw says Martial Arts. Either one dates it."
  },
  {
    slug: "herald-of-zakarum-08",
    name: "Herald of Zakarum",
    title: "1.08 Herald of Zakarum",
    alias: "cannot be frozen shield",
    quality: "unique",
    type: "Gilded Shield",
    sprite: "img/herald-of-zakarum.png",
    proof: "research/reference-screenshots/herald-of-zakarum-108.webp",
    lastPatch: "1.08",
    tooltip: [
      { t: "Defense: 253", c: "white" },
      { t: "Chance to Block: 62%", c: "white" },
      { t: "Durability: 33 of 50", c: "white" },
    ...
    rarityTier: "Very Rare",
    obscurity: 4,
    why: "The Herald everyone knows is a block and resist shield. Fifty resist all, thirty faster block, two skill lines. This one blocks half again as fast at fifty percent, carries cannot be frozen on a shield, and scales its undead damage and attack rating with your level to a hundred and ninety eight percent and nine hundred and ninety. It is built to smite undead in a version of the game nobody plays.",
    history: "Patch 1.09 raised the resistances from fifteen to fifty, cut the faster block from fifty to thirty, turned the single offensive auras line into two full skill lines, and stripped out both the cannot be frozen and the undead scaling. Better at almost everything, and far less strange.",
    ifYouFind: "Cannot Be Frozen on a Gilded Shield. Nothing that drops now has it. Fifty percent faster block is the second tell, since the modern shield gives thirty."
  },
  {
    slug: "deaths-web",
    name: "Death's Web",
